		...
		<div class="jp-type-single">
		    <div class="jp-gui jp-interface">
		        <ul class="jp-controls">
							...
							<li><a href="javascript:;" class="jp-random" tabindex="1" onclick="random_click()">random</a></li>
							<li><a href="javascript:;" class="jp-circle" tabindex="1" onclick="circle_click()">circle</a></li>
